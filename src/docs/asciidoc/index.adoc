...
==== CURL request
include::{snippets}/update-image-account/curl-request.adoc[]

==== Http Request
include::{snippets}/update-image-account/http-request.adoc[]

==== Request fields
include::{snippets}/update-image-account/request-fields.adoc[]

==== Http Response
include::{snippets}/update-image-account/http-response.adoc[]
