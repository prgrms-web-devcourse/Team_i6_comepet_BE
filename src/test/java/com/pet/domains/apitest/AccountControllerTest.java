...
class AccountControllerTest {
    ...
    private JwtAuthentication getAuthenticationToken() {
        ...
        resultActions
            ...
            .andDo(document("get-account-missing-bookmark-posts",
                ...
                responseFields(
                    ...
                    fieldWithPath("data.posts[0].city").type(STRING).description("시도"),
                    fieldWithPath("data.posts[0].town").type(STRING).description("시군구"),
